...
- [Log Pattern Lens](https://github.com/vugarbbakhishov-hub/log-pattern-lens) - a browser-only React and TypeScript utility for triaging pasted logs, folding stack traces, flagging possible sensitive lines, previewing reports, grouping repeated patterns and exporting CSV/JSON reports. [v0.1.0 release](https://github.com/vugarbbakhishov-hub/log-pattern-lens/releases/tag/v0.1.0). [Live demo](https://vugarbbakhishov-hub.github.io/log-pattern-lens/).
