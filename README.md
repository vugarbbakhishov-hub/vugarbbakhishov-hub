...
- [csv-quality](https://github.com/vugarbbakhishov-hub/csv-quality) — a zero-dependency TypeScript library and CLI for inspecting CSV structure, completeness, duplicates, column quality and CI quality gates.
