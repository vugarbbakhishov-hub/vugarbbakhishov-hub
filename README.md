...
- [Log Pattern Lens](https://github.com/vugarbbakhishov-hub/log-pattern-lens) - a browser-only React and TypeScript utility for triaging pasted logs, folding stack traces, grouping repeated patterns and exporting CSV/JSON reports. [Live demo](https://vugarbbakhishov-hub.github.io/log-pattern-lens/).
